            ...
            {GALLERY.map((src, i) => (
              <div
                ...
                className={`overflow-hidden bg-ink/10 shrink-0 ${
                  i === 2
                    ? "lg:row-span-2 aspect-[3/4] lg:aspect-auto w-[200px] sm:w-[250px] lg:w-full lg:h-full"
                    : i === 4
                      ? "lg:col-span-2 aspect-[3/2] lg:aspect-auto w-[400px] sm:w-[500px] lg:w-full lg:h-full"
                      : "aspect-square lg:aspect-auto w-[200px] sm:w-[250px] lg:w-full lg:h-full"
                }`}
              >
                <img
                  src={src}
